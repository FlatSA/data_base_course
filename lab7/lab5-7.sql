...
CREATE TABLE public.predmets_n (
    ...
    CONSTRAINT subject_set CHECK (((pname)::text = ANY ((ARRAY['Физика'::character varying, 'Химия'::character varying, 'Математика'::character varying, 'Философия'::character varying, 'Экономика'::character varying, 'Ин_яз'::character varying])::text[])))
);
...
1003	3	3414	2005	1999-06-11 00:00:00
...
1008	3	3414	2003	1999-06-14 00:00:00
